# Based on https://gist.github.com/cor3ntin/9e59018044c5a2b20a347cecedadb006

find_package(Boost 1.71 COMPONENTS system filesystem thread regex python date_time program_options)
if(Boost_FOUND)
    ...
    set( boost_SHA256 "d73a8da01e8bf8c7eda40b4c84915071a8c8a0df4a6734537ddde4a8580524ee" )
    set( boost_bootstrap ./bootstrap.sh)
    set( boost_b2 ./b2 )
    endif()
...
# target_include_directories(boost::beast
#                            SYSTEM
#                            PUBLIC
#                            "${boost_INCLUDE_DIR}")